...
public:
    ...
    float length() const;
    const rlottie_std::vector<VPath::Element> &elements() const;
    const rlottie_std::vector<VPointF> &       points() const;
...
private:
    struct VPathData {
        ...
        const rlottie_std::vector<VPointF> &points() const { return m_points; }
        rlottie_std::vector<VPointF>        m_points;
        rlottie_std::vector<VPath::Element> m_elements;
        size_t                      m_segments;
        VPointF                     mStartPoint;
...
inline const rlottie_std::vector<VPath::Element> &VPath::elements() const
{
    return d->elements();
}

inline const rlottie_std::vector<VPointF> &VPath::points() const
{
    return d->points();
}
